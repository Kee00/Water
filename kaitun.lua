...
ImageButton1.Image = "http://www.roblox.com/asset/?id=139590068646407"
...
local LogoHub = Instance.new("ImageLabel")
    ...
    LogoHub.Image = "http://www.roblox.com/asset/?id="..tostring(139590068646407)
...
local LogoToggle = Instance.new("ImageLabel")
    ...
    LogoToggle.Image = "http://www.roblox.com/asset/?id="..tostring(139590068646407)
        ...
        function main:AddDropdown(text,option,callback)
            ...
            DropImage.Image = "rbxassetid://139590068646407"
...
if game.PlaceId == 2753915549 then
    ...
    local Library = Update:Window("           Water","12523036534",Enum.KeyCode.RightControl);

local H = Library:AddTab("Main","6026568198")

H:AddSeperator("Player")
